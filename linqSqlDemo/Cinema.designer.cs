...
namespace linqSqlDemo
{
    ...
    partial void DeleteSale(Sale instance);
		...
		public CinemaDataContext() : 
				base(global::linqSqlDemo.Properties.Settings.Default.CinemaDbConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnPosti_OccupatiChanging(int value);
    partial void OnPosti_OccupatiChanged();
    ...
    partial void OnIDChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Posti_Occupati", DbType="Int NOT NULL")]
		public int Posti_Occupati
		{
			get
			{
				return this._Posti_Occupati;
			}
			set
			{
				if ((this._Posti_Occupati != value))
				{
					this.OnPosti_OccupatiChanging(value);
					this.SendPropertyChanging();
					this._Posti_Occupati = value;
					this.SendPropertyChanged("Posti_Occupati");
					this.OnPosti_OccupatiChanged();
				}
			}
		}
